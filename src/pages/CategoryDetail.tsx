  ...
  return (
    <div>
      ...
      <div className="flex-center" style={{ justifyContent: 'flex-start', gap: '1rem', marginBottom: '2rem' }}>
        ...
        <h1 style={{ fontSize: '2rem', fontWeight: 700, textTransform: 'capitalize' }}>{catName || catId} Commands</h1>
      </div>
      ...
      {loading ? (
        ...
        <div className="card flex-center" style={{ flexDirection: 'column', padding: '4rem 2rem', gap: '1rem' }}>
